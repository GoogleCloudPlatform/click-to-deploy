...
function replace_vars(){
    ...
    local VARS="\$DRAGONFLY_MANAGER_ADDR \$DRAGONFLY_MYSQL_USER \$DRAGONFLY_MYSQL_PW \$DRAGONFLY_MYSQL_HOST \$DRAGONFLY_MYSQL_DBNAME \$DRAGONFLY_REDIS_HOST \$DRAGONFLY_REDIS_PW"
    local TEMP_OUTPUT
