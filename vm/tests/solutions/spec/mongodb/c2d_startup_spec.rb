...
describe 'C2D startup scripts should exists' do
  ...
  describe file('/opt/c2d/scripts/01-mongodb-server') do
    it { should exist }
  end

  describe file('/opt/c2d/scripts/02-mongodb-arbiter') do
    it { should exist }
  end

  describe file('/opt/c2d/scripts/03-mongodb-validator') do
    it { should exist }
  end
end
