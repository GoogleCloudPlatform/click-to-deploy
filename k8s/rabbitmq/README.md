...
```shell
gcloud --project "$PROJECT" source repos clone google-click-to-deploy --project=k8s-marketplace-eap
gcloud --project "$PROJECT" source repos clone google-marketplace-k8s-app-tools --project=k8s-marketplace-eap
```
