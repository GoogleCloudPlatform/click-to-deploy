...
kubectl patch secret $name-tls -p "{\"metadata\":{\"ownerReferences\":[{\"apiVersion\":\"app.k8s.io/v1alpha1\",\"blockOwnerDeletion\":true,\"kind\":\"Application\",\"name\":\"$name\",\"uid\":\"$application_uid\"}]}}"
